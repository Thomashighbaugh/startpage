var tip = (function() {
  ...
  var render = function(tip) {
    ...
    tipWrapper.addEventListener(
      "transitionend",
      function(event, elapsed) {
        if (
          event.propertyName === "opacity" &&
          getComputedStyle(this).opacity == 0
        ) {
    ...
    tipWrapper.setAttribute(
      "style",
      "width: " +
        (parseInt(tipWrapper.getBoundingClientRect().width, 10) + 2) +
        "px;"
    );
    ...
    var left =
      ...
      parseInt(
        (width +
          ...
          parseInt(getComputedStyle(tipWrapper).marginRight, 10)) /
          2,
        10
      );
    ...
    if (
      tipWrapper.getBoundingClientRect().left <
      parseInt(getComputedStyle(tipWrapper).marginLeft, 10)
    ) {
      // console.log("too far left");
      tipWrapper.setAttribute(
        "style",
        "width: " + style.width + "; top: " + style.top + "; left: " + 0 + "px;"
      );
      tipArrow.setAttribute(
        "style",
        "left: " +
          (parseInt(tip.getBoundingClientRect().left, 10) +
            parseInt(tip.getBoundingClientRect().width / 2, 10) -
      ...
      tipWrapper.getBoundingClientRect().right >
