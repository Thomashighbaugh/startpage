var control = (function() {
  var _allControl = [
    ...
    {
      element: helper.e(
        ".control-link-item-display-alignment-horizontal-center"
      ),
      path: "link.item.display.alignment.horizontal",
      type: "radio",
      func: function() {
    ...
    {
      element: helper.e(
        ".control-link-item-display-alignment-horizontal-right"
      ),
      path: "link.item.display.alignment.horizontal",
      type: "radio",
      func: function() {
  ...
  var render = function() {
    ...
    var _header = function() {
      var _area = function() {
        ...
        helper.addClass(
          html,
          "is-header-area-alignment-horizontal-" +
      ...
      var _item = function() {
        ...
        helper.addClass(
          html,
          "is-header-item-alignment-horizontal-" +
            state.get().header.item.alignment.horizontal
        );
      };
      var _clock = function() {
        if (
          state.get().header.clock.seconds.show ||
          state.get().header.clock.minutes.show ||
          state.get().header.clock.hours.show
        ) {
      ...
      var _date = function() {
        if (
          state.get().header.date.date.show ||
          state.get().header.date.day.show ||
          state.get().header.date.month.show ||
          state.get().header.date.year.show
        ) {
      ...
      var _search = function() {
        ...
        if (state.get().header.search.show) {
          ...
          helper.addClass(
            html,
            "is-header-search-style-" + state.get().header.search.style
          );
          helper.addClass(
            html,
            "is-header-search-text-align-" +
              state.get().header.search.text.align
          );
        }
        helper.e(
          ".control-header-search-engine-custom-name"
        ).value = state.get().header.search.engine.custom.name;
        helper.e(
          ".control-header-search-engine-custom-url"
        ).value = state.get().header.search.engine.custom.url;
      };
      ...
      var _transitional = function() {
        if (
          state.get().header.transitional.show &&
          (state.get().header.date.date.show ||
            state.get().header.date.day.show ||
            state.get().header.date.month.show ||
            state.get().header.date.year.show ||
      ...
      var _shade = function() {
        ...
        if (state.get().header.shade.show) {
          ...
          helper.addClass(
            html,
            "is-header-shade-style-" + state.get().header.shade.style
          );
        }
    ...
    var _link = function() {
      ...
      if (state.get().link.show) {
        ...
        helper.addClass(
          html,
          "is-link-area-alignment-horizontal-" +
            state.get().link.area.alignment.horizontal
        );
        helper.addClass(
          html,
          "is-link-display-alignment-horizontal-" +
            state.get().link.item.display.alignment.horizontal
        );
        helper.addClass(
          html,
          "is-link-display-alignment-vertical-" +
            state.get().link.item.display.alignment.vertical
        );
        helper.addClass(html, "is-link-style-" + state.get().link.style);
        helper.addClass(
          html,
          "is-link-url-style-" + state.get().link.item.url.style
        );
    ...
    var _layout = function() {
      ...
      helper.addClass(
        html,
        "is-layout-alignment-horizontal-" +
          state.get().layout.alignment.horizontal
      );
      helper.addClass(
        html,
        "is-layout-alignment-vertical-" + state.get().layout.alignment.vertical
      );
  ...
  var dependents = function() {
    var _header = function() {
      var _clock = function() {
        ...
        if (
          (state.get().header.clock.seconds.show ||
            state.get().header.clock.minutes.show ||
            state.get().header.clock.hours.show) &&
          !state.get().header.clock.hour24.show
        ) {
          helper.e(".control-header-clock-meridiem-show").disabled = false;
        } else {
          helper.e(".control-header-clock-meridiem-show").disabled = true;
        ...
        if (
          ...
          helper
            .e("[for=control-header-clock-size]")
      ...
      var _date = function() {
        ...
        if (
          ...
          helper
            .e(".control-header-date-format-label")
            .removeAttribute("disabled");
        ...
        if (
          state.get().header.date.day.show &&
          state.get().header.date.day.display == "number"
        ) {
          helper
            .e(".control-header-date-day-week-start-label")
            .removeAttribute("disabled");
          helper.e(
        ...
        if (
          state.get().header.date.day.show &&
          state.get().header.date.day.display == "word"
        ) {
          helper
            .e(".control-header-date-day-length-label")
            .removeAttribute("disabled");
        ...
        if (
          state.get().header.date.month.show &&
          state.get().header.date.month.display == "word"
        ) {
          helper
            .e(".control-header-date-month-length-label")
            .removeAttribute("disabled");
        ...
        if (
          state.get().header.date.month.show &&
          state.get().header.date.month.display == "number"
        ) {
        ...
        if (
          ...
          helper
            .e("[for=control-header-date-size]")
            .removeAttribute("disabled");
      ...
      var _shade = function() {
        if (state.get().header.shade.show) {
          ...
          helper
            .e("[for=control-header-shade-opacity]")
            .removeAttribute("disabled");
      ...
      var _search = function() {
        if (state.get().header.search.show) {
          ...
          helper
            .e(".control-header-search-text-align-label")
            .removeAttribute("disabled");
          ...
          helper
            .e("[for=control-header-search-size]")
            .removeAttribute("disabled");
        ...
        if (
          state.get().header.search.show &&
          state.get().header.search.engine.selected === "custom"
        ) {
          helper
            .e("[for=control-header-search-engine-custom-name]")
            .removeAttribute("disabled");
          helper.e(
            ".control-header-search-engine-custom-name"
          ).disabled = false;
          helper
            .e("[for=control-header-search-engine-custom-url]")
            .removeAttribute("disabled");
        ...
        if (
          state.get().header.search.show &&
          state.get().header.search.style === "custom"
        ) {
          helper
            .e("[for=control-header-search-width]")
            .removeAttribute("disabled");
      ...
      var _greeting = function() {
        if (state.get().header.greeting.show) {
          helper
            .e("[for=control-header-greeting-name]")
            .removeAttribute("disabled");
          ...
          helper
            .e("[for=control-header-greeting-size]")
            .removeAttribute("disabled");
      ...
      var _transitional = function() {
        ...
        if (
          ...
          helper
            .e("[for=control-header-transitional-size]")
            .removeAttribute("disabled");
    ...
    var _link = function() {
      ...
      helper
        .e(".control-link-area-alignment-horizontal-label")
        .setAttribute("disabled", "");
      helper.e(".control-link-area-alignment-horizontal-left").disabled = true;
      helper.e(
        ".control-link-area-alignment-horizontal-center"
      ).disabled = true;
      ...
      helper
        .e("[for=control-link-item-display-letter-size]")
        .setAttribute("disabled", "");
      helper.e(".control-link-item-display-letter-size").disabled = true;
      helper.e(
        ".control-link-item-display-letter-size-default"
      ).disabled = true;
      helper
        .e("[for=control-link-item-display-icon-size]")
        .setAttribute("disabled", "");
      ...
      helper
        .e("[for=control-link-item-name-size]")
        .setAttribute("disabled", "");
      ...
      helper
        .e(".control-link-item-display-alignment-horizontal-label")
        .setAttribute("disabled", "");
      helper.e(
        ".control-link-item-display-alignment-horizontal-left"
      ).disabled = true;
      helper.e(
        ".control-link-item-display-alignment-horizontal-center"
      ).disabled = true;
      ...
      helper
        .e(".control-link-item-display-alignment-vertical-label")
        .setAttribute("disabled", "");
      helper.e(
        ".control-link-item-display-alignment-vertical-top"
      ).disabled = true;
      helper.e(
        ".control-link-item-display-alignment-vertical-center"
      ).disabled = true;
      helper.e(
        ".control-link-item-display-alignment-vertical-bottom"
      ).disabled = true;
      ...
      if (state.get().link.show) {
        ...
        helper
          ...
          .removeAttribute("disabled");
        helper.e(
          ".control-link-area-alignment-horizontal-left"
        ).disabled = false;
        helper.e(
          ".control-link-area-alignment-horizontal-center"
        ).disabled = false;
        helper.e(
          ".control-link-area-alignment-horizontal-right"
        ).disabled = false;
        ...
        if (state.get().link.item.display.show) {
          ...
          helper.e(
            ".control-link-item-display-icon-size-default"
          ).disabled = false;
        }
        if (state.get().link.item.name.show) {
          helper
        ...
        if (
          state.get().link.item.display.show ||
          state.get().link.item.name.show ||
          state.get().link.item.url.show
        ) {
          helper
            .e(".control-link-item-display-alignment-horizontal-label")
            .removeAttribute("disabled");
  ...
  var update = function() {
    ...
    var setValue = {
      ...
      radio: function(object) {
        helper.e(
          "." +
            object.element.className.substring(
              0,
              object.element.className.lastIndexOf("-") + 1
            ) +
            helper.getObject({
              object: state.get(),
              path: object.path
      ...
      range: function(object) {
        ...
        if (object.valueMod) {
          object.valueMod
            .slice()
            .reverse()
            .forEach(function(arrayItem, index) {
      ...
      color: function(object) {
        object.element.value = helper.rgbToHex(
          helper.getObject({
            object: state.get(),
            path: object.path
          })
