...
if (
  (void 0 === self.Iconify &&
    ...
    (function (e, t) {
      ...
      function se() {
        document.removeEventListener("DOMContentLoaded", se),
          window.removeEventListener("load", se),
          o.DOMReadyCallback();
      }
      function ce(t, i, e) {
        var n = t;
      ...
      function de(e) {
        ...
        return (
          (void 0 === e._defaults ? [e, v] : [e, e._defaults, v]).forEach(
            function (t) {
          ...
          void 0 === i.verticalAlign &&
            (i.height % 7 == 0 && i.height % 8 != 0
              ? (i.verticalAlign = -0.143)
              : (i.verticalAlign = -0.125)),
          i
        );
      }
      function fe() {
        return (
          ...
          (this._add = function (e, t, i) {
            ...
            void 0 === this._resolved[t.prefix]
              ? ((this._resolved[t.prefix] = Object.create(null)),
                (this._icons[t.prefix] = Object.create(null)),
                (this._aliases[t.prefix] = Object.create(null)))
              : (delete this._icons[t.prefix][t.icon],
          ...
          (this._resolveIcon = function (e) {
            var t, i, n, o, r, a;
            if (
              void 0 === this._resolved[e.prefix] ||
              void 0 === this._resolved[e.prefix][e.icon]
            )
              return null;
            if (!1 !== this._resolved[e.prefix][e.icon])
              return this._resolved[e.prefix][e.icon];
            if (void 0 !== this._icons[e.prefix][e.icon])
              return (this._resolved[e.prefix][e.icon] = de(
                this._icons[e.prefix][e.icon]
              ));
            for (
              i = 0,
              ...
              if (
                ((r = void 0 === this._icons[e.prefix][o]),
                (a = this[r ? "_aliases" : "_icons"][e.prefix][o]),
          ...
          (this.addCollection = function (n) {
            ...
            g.forEach(function (e) {
              ...
              void 0 !== n.icons &&
                Object.keys(n.icons).forEach(function (e) {
                  var t = p(e, n.prefix),
                    i = n.icons[e];
                  void 0 !== i.body && ((i._defaults = r), o._add(!1, t, i));
                }),
              void 0 !== n.aliases &&
                Object.keys(n.aliases).forEach(function (e) {
                  var t = p(e, n.prefix),
                    i = n.aliases[e];
                  if (void 0 !== i.parent) {
                    if (void 0 === n.prefix) {
          ...
          (this.exists = function (e, t) {
            var i = p(e, t);
            return (
              void 0 !== this._resolved[i.prefix] &&
              void 0 !== this._resolved[i.prefix][i.icon]
            );
          }),
          ...
          (this.list = function (e) {
            var i, n;
            return void 0 !== e
              ? void 0 === this._resolved[e]
                ? []
                : Object.keys(this._resolved[e])
              : ((i = []),
                (n = this._resolved),
                Object.keys(n).forEach(function (t) {
                  i = i.concat(
                    Object.keys(n[t]).map(function (e) {
      ...
      function pe(e, t, i) {
        var n, o, r, a, s;
        if (1 === t) return e;
        if (((i = void 0 === i ? 100 : i), "number" == typeof e))
          return Math.ceil(e * t * i) / i;
        if ("string" != typeof e) return e;
        if (null === (n = e.split(j)) || !n.length) return e;
        for (o = [], r = n.shift(), a = A.test(r); ; ) {
          if (
            (a
              ? ((s = parseFloat(r)),
                isNaN(s) ? o.push(r) : o.push(Math.ceil(s * t * i) / i))
              : o.push(r),
            void 0 === (r = n.shift()))
          )
            return o.join("");
      ...
      function be() {
        var a = N.loaderMaxURLSize,
          o = Object.create(null);
        function s(e, t) {
          var i,
            n = o[e];
          "function" != typeof n
            ? ((n = n.replace("{icons}", t.join(","))),
        ...
        Object.keys(T).forEach(function (i) {
          var n = c(i),
            o = !1 === n,
            r = [];
          if (null === n) return s(i, []), void (F[i] = !0);
          T[i].forEach(function (e, t) {
            o ||
              ((n += e.length + 1),
              a <= n && (s(i, r), (r = []), (n = c(i) + e.length + 1))),
              r.push(e);
          }),
            r.length && s(i, r),
      ...
      function me(e, t, i) {
        return i || S.domready || N.loadBeforeDOMReady
          ? (void 0 === T[e] || -1 === T[e].indexOf(t)) &&
              (void 0 === F[e] || (!0 !== F[e] && -1 === F[e].indexOf(t))) &&
              (void 0 === T[e] && (T[e] = []),
              T[e].push(t),
              D || ((D = !0), window.setTimeout(be, 0)),
              1)
          : ((o = t),
            void 0 === R[(n = e)] && (R[n] = Object.create(null)),
            (R[n][o] = !0),
            void 0 === S._loaderDOMReady &&
              ((S._loaderDOMReady = S.DOMReadyCallback),
      ...
      function ye() {
        var e;
        !1 !== U && U.length ? ((e = U), (U = !1), Q.scanDOM(e)) : (U = !1);
      }
      function we(e) {
      ...
      function _e() {
        q.observe(
          void 0 === z._root ? document.querySelector("body") : z._root,
          W
        );
      }
      function xe(e, t) {
        ...
        return (
          "<?" === e.slice(0, 2) &&
            ((i = e.indexOf(">")), (e = e.slice(i + 1))),
          (e =
            -1 !==
            (i = (e = e
              .replace("viewbox=", "viewBox=")
              .replace("preserveaspectratio=", "preserveAspectRatio=")).indexOf(
              "</"
            ))
              ? e.replace("</", t + "</")
              : e.replace("/>", ">" + t + "</svg>"))
      ...
      (i = re),
        "function" != typeof window.CustomEvent &&
          ((ae.prototype = window.Event.prototype), (window.CustomEvent = ae)),
        ...
        (o.DOMReadyCallback = function () {
          (o.domready = !0), o.nextInitItem();
        }),
        (o.initTimeout = function (e) {
          function t() {
            if (null !== a) {
              if (!1 !== a.callback()) return a.stop(), void o.nextInitItem();
              a.counter++,
                (10 !== a.counter && 25 !== a.counter) ||
                  (window.clearInterval(a.id),
                  (a.id = window.setInterval(t, 10 === a.counter ? 250 : 1e3)));
            }
          }
          null !== a && a.stop(),
            (a = {
              ...
              callback: e,
              stop: function () {
                window.clearInterval(a.id), (a = null);
              },
              nextTick: t,
            });
        }),
            ...
            if (o.initQueue.length) e = o.initQueue.shift();
              ...
              if (!o.domready)
                return void o.initTimeout(function () {
                  return (
                    !o.domready && document.body && o.scanDOM(), o.domready
                  );
                });
        ...
        (n.ready = function (e) {
          n.isReady
            ? window.setTimeout(e)
            : document.addEventListener(r._readyEvent, e);
        }),
        window.setTimeout(function () {
          ...
          ("loading" !== document.readyState &&
            ...
            : (document.addEventListener("DOMContentLoaded", se),
              window.addEventListener("load", se)),
            o.nextInitItem();
        }),
        ((s = re.config).SVGAttributes = Object.create(null)),
        (s._imageClass = "iconify"),
        (s._loadingClass = "svg-loading"),
        (s._iconAttribute = "data-icon"),
        (s._rotateAttribute = "data-rotate"),
        (s._flipAttribute = "data-flip"),
        (s._inlineModeAttribute = "data-inline"),
        (s._alignAttribute = "data-align"),
        (s._appendAttribute = "data-icon-append"),
        (s._appendedClass = "svg-appended"),
        (s._readyEvent = "IconifyReady"),
        (s._webComponentsPolyfill =
          "https://cdnjs.cloudflare.com/ajax/libs/webcomponentsjs/0.7.24/webcomponents-lite.min.js"),
        (s._classListPolyfill =
          "https://cdnjs.cloudflare.com/ajax/libs/classlist/1.1.20150312/classList.min.js"),
        (function (t) {
          (t.defaultAPI =
            "https://api.iconify.design/{prefix}.js?icons={icons}"),
        ...
        d.initQueue.push(function () {
          ...
          function o() {
            return (
              (h.MutationObserver && h.WeakMap) ||
                t.observer ||
                (t.observer = i(f._webComponentsPolyfill)),
              1
            );
          }
          return (
            (e.classList = !n()),
            (e.observer = !o()),
            (!e.classList && !e.observer) ||
              (d.initTimeout(function () {
        ...
        (fe.blankIcon = function () {
          return de({ body: "", width: 16, height: 16 });
        }),
        (re.Storage = fe),
        (b = e),
        (y = t),
        ...
        (b.addCollection = function (e, t) {
          _.addCollection(e),
            w || !0 === t || ((w = !0), window.setTimeout(he, 0));
        }),
        (b.addIcon = function (e, t, i) {
          _.addIcon(e, t),
            w || !0 === i || ((w = !0), window.setTimeout(he, 0));
        }),
        ...
        ["SimpleSVG", "Iconify"].forEach(function (e) {
          void 0 !== y[e + "Preload"] &&
            y[e + "Preload"] instanceof Array &&
            y[e + "Preload"].forEach(function (e) {
          ...
          return (
            ...
            (this.height = function (e, t, i) {
              return void 0 === e
                ...
                : pe(
                    e,
                    (t ? this.item.inlineHeight : this.item.height) /
                      this.item.width,
                    i
                  );
            }),
            ...
            (this.attributes = function (t) {
              ...
              if (
                ((a = ve(
                  (t = "object" == typeof t ? t : Object.create(null)),
                  [O._inlineModeAttribute, "inline"],
                  !0
                )),
                (u = ve(t, [O._appendAttribute], !1)),
                (e = {
                  left: _.left,
                  top: a ? _.inlineTop : _.top,
                  width: _.width,
                  height: a ? _.inlineHeight : _.height,
                }),
                "string" == typeof t[O._flipAttribute] &&
                  t[O._flipAttribute].split(/[\s,]+/).forEach(function (e) {
                ...
                if ("number" == typeof (c = t[O._rotateAttribute]))
                  ...
                  if ("" === (d = c.replace(/^-?[0-9.]*/, "")))
                    (c = parseInt(c)), isNaN(c) || (b.rotate += c);
                  else if (d !== c) {
                    switch (((l = !1), d)) {
                      case "%":
                        l = 25;
                    ...
                    l &&
                      ((c = parseInt(c.slice(0, c.length - d.length))),
                      isNaN(c) || (b.rotate += Math.round(c / l)));
                  }
              switch (
                (b.hFlip
                  ? b.vFlip
                ...
                case 1:
                  (p = e.height / 2 + e.top),
                    w.unshift("rotate(90 " + p + " " + p + ")"),
                    (0 === e.left && 0 === e.top) ||
                      ((p = e.left), (e.left = e.top), (e.top = p)),
                    e.width !== e.height &&
                      ((p = e.width), (e.width = e.height), (e.height = p));
                  break;
                case 2:
                  w.unshift(
                    "rotate(180 " +
              ...
              return (
                (i = ge(t, ["data-width", "width"], null)),
                (n = ge(t, ["data-height", "height"], null)),
                null === i && null === n && (n = "1em"),
                null !== i && null !== n
                  ? ((o = i), (r = n))
                  : null !== i
                  ? (r = pe((o = i), e.height / e.width))
                  : (o = pe((r = n), e.width / e.height)),
                !1 !== o && (y.width = "auto" === o ? e.width : o),
                !1 !== r && (y.height = "auto" === r ? e.height : r),
                a && 0 !== _.verticalAlign
                  ? (m +=
                      "vertical-align: " + (h = _.verticalAlign + "em") + ";")
                  : (h = ""),
                "string" == typeof t[O._alignAttribute] &&
                  t[O._alignAttribute]
                    .toLowerCase()
                    .split(/[\s,]+/)
                    .forEach(function (e) {
                ...
                (y.style = m + (void 0 === t.style ? "" : t.style)),
                (y.preserveAspectRatio = this.preserveAspectRatio(
                  g.horizontal,
                  g.vertical,
                  g.crop
                )),
                  ...
                  void 0 === y[e] &&
                    (-1 !== E.indexOf(e)
                      ? (s =
                          ...
                          e +
                          ">" +
                          v.htmlspecialchars(t[e]) +
                          "</" +
                          e +
                          ">" +
                          s)
                      : -1 === I.indexOf(e) && (f[e] = t[e]));
                }),
                {
                  attributes: y,
                  elementAttributes: f,
        ...
        (C.getImageAttributes = function (t) {
          ...
          for (e = 0; e < t.element.attributes.length; e++)
            (i = t.element.attributes[e]), (n[i.name] = i.value);
          return (
            t.parser &&
              void 0 !== t.parser.filterAttributes &&
              (n = t.parser.filterAttributes(t, n)),
            void 0 !== n.class &&
              ((n.class = n.class.split(" ").filter(function (e) {
                return e !== M;
              })),
              t.parser &&
                void 0 !== t.parser.filterClasses &&
                (n.class = t.parser.filterClasses(t, n.class)),
        ...
        (function (n, f, e) {
            ...
            h = {
              iconify: {
                ...
                filterClasses: function (e, t) {
                  var i, n, o;
                  for (n = 0; n < t.length; n++)
                    "icon-" === (i = t[n]).slice(0, 5) &&
                      2 === (i = i.slice(5).split(":")).length &&
                      ((o = "data-" + i[0]),
                      void 0 === e.attributes &&
                        (e.attributes = Object.create(null)),
                      (e.attributes[o] = i[1]));
                  return t;
                },
              },
          ...
          (n.addFinder = function (e, t) {
            void 0 === t.selectorAll && (t.selectorAll = t.selector + r),
              ...
              void 0 === t.selectorLoading &&
                (t.selectorLoading = t.selector + r + l),
              (h[e] = t),
              (p = Object.keys(h)),
              n.isReady && n.scanDOM();
          }),
          ...
          n.addTag("iconify-icon", !1),
                  ...
                  p.forEach(function (e) {
                    ...
                    for (t = 0; t < s.length; t++)
                      (i = s[t]),
                        (n = r.icon(i)) &&
                          -1 === d.indexOf(i) &&
                          (d.push(i), (o = f.newImage(i, n, r)), u.push(o));
                  }),
                u
              );
            }),
            (f.findParsedImages = function (e) {
              var t,
                ...
                n,
                o = [],
                r = e.querySelectorAll("svg." + a);
              for (t = 0; t < r.length; t++)
                (n = (i = r[t]).getAttribute(s)) && o.push(f.parsedImage(i, n));
              return o;
            });
        })(e, re, re.config),
        (L = e),
        ...
        (S.loadImage = function (e, t) {
          ...
          return (
            !!L.iconExists(i.icon, i.prefix) ||
            (!1 !== t &&
              me(i.prefix, i.icon, !1) &&
              e.element.classList.add(N._loadingClass),
            !1)
          );
        }),
        (L.preloadImages = function (e) {
          ...
          return (
            e.forEach(function (e) {
              (t = S.getPrefix(e)),
                L.iconExists(t.icon, t.prefix) ||
                  (me(t.prefix, t.icon, !0), (i = !0));
            }),
            i
          );
        }),
        ["local", "session"].forEach(function (t) {
          ...
          try {
            ...
            if (
              "number" != typeof (n = parseInt(e.getItem("iconify-count"))) ||
              isNaN(n)
            )
              return;
            for (;;) {
              if (V[t] >= n) return;
              if ("string" != typeof (i = e.getItem("iconify" + V[t]))) return;
        ...
        (B = t),
        (Y = 0),
        (W = { childList: !(U = !1), subtree: !(J = q = null) }),
        (G.pauseObserving = function () {
          null !== q && (Y || ((J = q.takeRecords()), q.disconnect())), Y++;
        }),
        (G.resumeObserving = function () {
          null !== q
            ? Y && (--Y || (_e(), null !== J && J.length && we(J)))
            : Y--;
        }),
        ...
        Q.readyQueue.push(function () {
          return (q = new B.MutationObserver(we)), Y || _e(), !0;
        }),
        ($ = e),
        (X = (K = re).config),
        (Z = X._iconAttribute),
          ...
          for (
            d[Z] = t.icon,
              ...
              Object.keys(r.elementAttributes).forEach(function (e) {
                try {
                  (r.append ? t.element : n).setAttribute(
                    e,
                    r.elementAttributes[e]
                  );
                } catch (e) {}
              }),
              t.loading &&
                (n.classList.remove(ee),
                r.append && t.element.classList.remove(ee)),
              n.classList.add(te),
              a = xe(n.outerHTML, r.body),
              (o = document.createElement("span")).innerHTML = a,
              i = o.childNodes[0],
              r.append
                ? (t.element.classList.add(ie), t.element.appendChild(i))
                : (t.element.parentNode.replaceChild(i, t.element),
                  (t.element = i)),
              s = i.style,
              c = t.element.style,
              r.verticalAlign && (s.verticalAlign = r.verticalAlign),
        ...
        ((oe = re).scanDOM = function () {
          ...
          function e() {
            oe.findNewImages().forEach(function (e) {
              oe.loadImage(e) &&
                (t || ((t = !0), ne.pauseObserving()), oe.renderSVG(e));
            });
          }
          if (oe.ready) e();
          else
  ...
  try {
    (exports.__esModule = !0), (exports.default = self.Iconify);
  } catch (e) {}
